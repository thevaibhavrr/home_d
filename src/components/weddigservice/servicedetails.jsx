...
function CategoryPage() {
  ...
  const [productStatus, setProductStatus] = useState('open');  // This is the variable to control product's status

  // Dynamic function to determine whether a product is open or closed
  const isProductOpen = (availableTimes) => {
    return productStatus === 'open';  // Check if the status is 'open'
  };
  ...
  return (
    <div className="category-page">
      ...
      {/* Toggle button to change product status */}
      {/* <button onClick={() => setProductStatus(productStatus === 'open' ? 'closed' : 'open')}>
        {productStatus === 'open' ? 'Set All Products to Closed' : 'Set All Products to Open'}
      </button> */}

      <div className="product-list">
        {products.map((product) => {
          const isOpen = isProductOpen(product.availableTimes); // Check product status using the new variable
          return (
            <motion.div
